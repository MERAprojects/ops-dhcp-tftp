...
static int show_dhcp_leases(void)
{
    char cmd_buff[256];
...
/*******************************************************************
 * @func        : dhcp_tftp_ovsdb_init
 * @detail      : Add dhcp_tftp related table & columns to ops-cli
 *                idl cache
 *******************************************************************/
static void
...
/* Initialize DHCP-TFTP related cli node.
 */
void
cli_pre_init(void)
{
    ...
    /* Register show running-config context with vtysh */
